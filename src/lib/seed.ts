...
export const modules = [
  ...
  },
  {
    ...
    order: 2,
    summaryPdfUrl: 'https://files.catbox.moe/w857w8.pdf',
  },
  {
    id: '3',
...
export const lessons = [
  // Módulo 1
  { id: '101', moduleId: '1', title: 'Aula 1: O que é procrastinação?', youtubeId: 'BpYYVSFZYfs', order: 1, durationSec: 300, summaryPdfUrl: null },
  { id: '102', moduleId: '1', title: 'Aula 2: O ciclo vicioso', youtubeId: 'ImZ2abenGkw', order: 2, durationSec: 320, summaryPdfUrl: null },
  { id: '103', moduleId: '1', title: 'Aula 3: Mitos e verdades', youtubeId: '3EwH4EghGqw', order: 3, durationSec: 280, summaryPdfUrl: null },
  { id: '104', moduleId: '1', title: 'Aula 4: O custo da inação', youtubeId: 'zJJBkLtEVZM', order: 4, durationSec: 350, summaryPdfUrl: null },
  ...
  // Módulo 3
  { id: '301', moduleId: '3', title: 'Aula 1: A regra dos 2 minutos', youtubeId: 'a_qR-oH1gV8', order: 1, durationSec: 280, summaryPdfUrl: null },
  { id: '302', moduleId: '3', title: 'Aula 2: Técnica Pomodoro na prática', youtubeId: 'r2145b58', order: 2, durationSec: 340, summaryPdfUrl: null },
  { id: '303', moduleId: '3', title: 'Aula 3: "Coma o sapo"', youtubeId: 'Tnwk-22Ab3E', order: 3, durationSec: 300, summaryPdfUrl: null },
  { id: '304', moduleId: '3', title: 'Aula 4: Dividir para conquistar', youtubeId: 'w2n2bfpYnI4', order: 4, durationSec: 320, summaryPdfUrl: null },
  { id: '305', moduleId: '3', title: 'Aula 5: Recompensas inteligentes', youtubeId: '9v5tJo2eL0A', order: 5, durationSec: 310, summaryPdfUrl: null },

  // Módulo 4
  { id: '401', moduleId: '4', title: 'Aula 1: Como hábitos funcionam', youtubeId: 'dtrYk5IuVvI', order: 1, durationSec: 330, summaryPdfUrl: null },
  { id: '402', moduleId: '4', title: 'Aula 2: Empilhamento de hábitos', youtubeId: 'fzeHAfhp39Y', order: 2, durationSec: 290, summaryPdfUrl: null },
  { id: '403', moduleId: '4', title: 'Aula 3: O diário de progresso', youtubeId: 'KzZy35_k_wI', order: 3, durationSec: 310, summaryPdfUrl: null },
  { id: '404', moduleId: '4', title: 'Aula 4: Lidando com falhas', youtubeId: 'X7gh_A3locY', order: 4, durationSec: 340, summaryPdfUrl: null },
  { id: '405', moduleId: '4', title: 'Aula 5: A identidade de quem faz', youtubeId: 'PZ7lDrwYdZc', order: 5, durationSec: 300, summaryPdfUrl: null },

  // Módulo 5
  { id: '501', moduleId: '5', title: 'Aula 1: Mentalidade de crescimento', youtubeId: 'ICj_ohyI_g4', order: 1, durationSec: 320, summaryPdfUrl: null },
